...
const ExperienceRow = ({ entry }: { entry: ExperienceEntry }) => {
  ...
  return (
    <div className="group relative grid grid-cols-1 gap-x-6 gap-y-2 border-b border-border/70 p-5 transition-colors hover:bg-muted/30 last:border-b-0 sm:grid-cols-[136px_1fr]">
